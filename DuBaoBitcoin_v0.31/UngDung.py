...
# ========================================================================================================================
# GIAO DIỆN CHỌN NGÀY DỰ BÁO TƯƠNG LAI (NẰM GIỮA DỮ LIỆU VÀ NÚT CHẠY)
...
# Tính số bước (số ngày) cần dự báo thêm vào tương lai
...
if st.button(" Chạy thực nghiệm so sánh & Dự báo tương lai"):
    ...
    # Khởi tạo danh sách mốc thời gian hiển thị mở rộng (bao gồm cả tương lai)
    ...
    with st.spinner("Đang chạy mô hình ARIMA ..."):
        ...
        # 2. Dự báo nối tiếp ra tương lai
    ...
    # --------------------------------------------------------------------------------------------------------------------
    # Tính toán các chỉ số sai số thống kê (Chỉ tính trên tập thực nghiệm quá khứ)
    ...
    # Vẽ đường thực tế (chỉ chạy trong phạm vi quá khứ có data test ban đầu)
    ...
    # Thêm đường thẳng đứng phân cách rõ biên giới giữa Quá khứ và Tương lai
    ...
    # --------------------------------------------------------------------------------------------------------------------
    # Đồ thị tán xạ tương quan tuyến tính (Scatter Plots - Giữ nguyên gốc chỉ tính trên tập Test)
    ...
    # --------------------------------------------------------------------------------------------------------------------
    # Đồ thị chẩn đoán nội tại mô hình đề xuất CNN-LSTM (Giữ nguyên)
    ...
    # --------------------------------------------------------------------------------------------------------------------
    # Bảng tổng kết sai số thực nghiệm định lượng (Giữ nguyên)
    ...
    # --------------------------------------------------------------------------------------------------------------------
    # Đồng bộ hóa bộ nhớ Session State (Lưu trữ cả chuỗi kết quả mở rộng ra Excel)
