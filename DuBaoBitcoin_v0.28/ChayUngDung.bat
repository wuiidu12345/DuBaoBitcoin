...
if not exist "%EMBEDDED_CONDA%\envs\DeepLearning" (
    ...
    echo [INFO] Đang tiến hành khởi tạo môi trường ảo mới tự động, vui lòng chờ...
    echo.
    :: Lệnh tạo môi trường ảo con đặt tên là DeepLearning chạy Python 3.10 đồng bộ lõi
